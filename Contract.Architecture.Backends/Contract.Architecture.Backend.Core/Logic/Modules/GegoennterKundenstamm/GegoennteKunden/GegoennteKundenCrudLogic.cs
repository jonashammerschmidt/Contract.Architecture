...
namespace Contract.Architecture.Backend.Core.Logic.Modules.GegoennterKundenstamm.GegoennteKunden
{
    internal class GegoennteKundenCrudLogic : IGegoennteKundenCrudLogic
    {
        ...
        public ILogicResult<IEnumerable<IGegoennterKunde>> GetGegoennteKunden()
        {
            IEnumerable<IGegoennterKunde> gegoennteKunden = this.gegoennteKundenCrudRepository.GetGegoennteKunden()
                .Select(dbGegoennterKunde => GegoennterKunde.FromDbGegoennterKunde(dbGegoennterKunde));

            this.logger.LogDebug("GegoennteKunden wurden geladen");
            return LogicResult<IEnumerable<IGegoennterKunde>>.Ok(gegoennteKunden);
        }
