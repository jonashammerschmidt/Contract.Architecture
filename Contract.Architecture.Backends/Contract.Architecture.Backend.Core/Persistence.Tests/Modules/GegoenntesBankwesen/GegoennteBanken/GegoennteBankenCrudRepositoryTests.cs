...
namespace Contract.Architecture.Backend.Core.Persistence.Tests.Modules.GegoenntesBankwesen.GegoennteBanken
{
    ...
    public class GegoennteBankenCrudRepositoryTests
    {
        ...
        [TestMethod]
        public void GetAllGegoennteBankenDefaultTest()
        {
            // Arrange
            GegoennteBankenCrudRepository gegoennteBankenCrudRepository = this.GetGegoennteBankenCrudRepositoryDefault();

            // Act
            IDbGegoennteBank[] dbGegoennteBanken = gegoennteBankenCrudRepository.GetAllGegoennteBanken().ToArray();

            // Assert
            Assert.AreEqual(2, dbGegoennteBanken.Length);
            DbGegoennteBankTest.AssertDbDefault(dbGegoennteBanken[0]);
            DbGegoennteBankTest.AssertDbDefault2(dbGegoennteBanken[1]);
        }
        ...
        public void GetGegoennteBankenDefaultTest()
        {
            ...
            // Assert
            IDbGegoennteBank[] dbGegoennteBanken = dbGegoennteBankenPagedResult.Data.ToArray();
            Assert.AreEqual(2, dbGegoennteBanken.Length);
            DbGegoennteBankTest.AssertDbDefault(dbGegoennteBanken[0]);
            DbGegoennteBankTest.AssertDbDefault2(dbGegoennteBanken[1]);
        }
