...
{
    internal class DbGegoennterKundeListItem : IDbGegoennterKundeListItem
    {
        ...
        internal static IDbGegoennterKundeListItem FromEfGegoennterKunde(EfGegoennterKunde efGegoennterKunde)
        {
            ...
            return new DbGegoennterKundeListItem()
            {
